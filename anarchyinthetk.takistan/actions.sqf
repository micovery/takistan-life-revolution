...
'_no = ceil(random 7);if (((call INV_GetOwnWeight) + ("boar" call INV_GetItemTypeKg)*_no) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getPosATL player, ["wildboar"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getPosATL player, ["wildboar"],  3] select 0);[player, "boar", _no] call INV_AddInventoryItem;player groupchat format["you got %1 boar meat", _no];',
1,true,true,"",
'_w = (nearestobjects [getPosATL player, ["wildboar"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getPosATL player, ["wildboar"],  3] select 0) < 5 and !alive (nearestobjects [getPosATL player, ["wildboar"],  3] select 0) and isciv'];

action_h2 =	_role addaction ["Take rabbit meat","noscript.sqf",
'_no = ceil(random 2);if (((call INV_GetOwnWeight) + ("rabbit" call INV_GetItemTypeKg)*_no) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getPosATL player, ["rabbit"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getPosATL player, ["rabbit"],  3] select 0);[player, "rabbit", _no] call INV_AddInventoryItem;player groupchat format["you got %1 rabbit meat", _no];',
1,true,true,"",
'_w = (nearestobjects [getPosATL player, ["rabbit"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getPosATL player, ["rabbit"],  3] select 0) < 5 and !alive (nearestobjects [getPosATL player, ["rabbit"],  3] select 0) and isciv'];

action_h3 =	_role addaction ["Take Chicken meat","noscript.sqf",
'_no = ceil(random 2);if (((call INV_GetOwnWeight) + ("chicken" call INV_GetItemTypeKg)*_no) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getPosATL player, ["Hen"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getPosATL player, ["Hen"],  3] select 0);[player, "chicken", _no] call INV_AddInventoryItem;player groupchat format["you got %1 chicken meat", _no];',
1,true,true,"",
'_w = (nearestobjects [getPosATL player, ["Hen"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getPosATL player, ["Hen"],  3] select 0) < 5 and !alive (nearestobjects [getPosATL player, ["Hen"],  3] select 0) and isciv'];

action_h4 =	_role addaction ["Take Cow meat","noscript.sqf",
'_no = ceil(random 2);if (((call INV_GetOwnWeight) + ("cow" call INV_GetItemTypeKg)*_no) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getPosATL player, ["Cow"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getPosATL player, ["Cow"],  3] select 0);[player, "cow", _no] call INV_AddInventoryItem;player groupchat format["you got %1 cow meat", _no];',
1,true,true,"",
'_w = (nearestobjects [getPosATL player, ["Cow"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getPosATL player, ["Cow"],  3] select 0) < 5 and !alive (nearestobjects [getPosATL player, ["Cow"],  3] select 0) and isciv'];

action_h5 =	_role addaction ["Take Dog meat","noscript.sqf",
'_no = ceil(random 2);if (((call INV_GetOwnWeight) + ("dog" call INV_GetItemTypeKg)*_no) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getPosATL player, ["Fin", "Pastor"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getPosATL player, ["Fin", "Pastor"],  3] select 0);[player, "dog", _no] call INV_AddInventoryItem;player groupchat format["you got %1 dog meat", _no];',
1,true,true,"",
'_w = (nearestobjects [getPosATL player, ["Fin", "Pastor"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getPosATL player, ["Fin", "Pastor"],  3] select 0) < 5 and !alive (nearestobjects [getPosATL player, ["Fin", "Pastor"],  3] select 0) and isciv'];

action_h6 =	_role addaction ["Take Sheep meat","noscript.sqf",
'_no = ceil(random 2);if (((call INV_GetOwnWeight) + ("sheep" call INV_GetItemTypeKg)*_no) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getPosATL player, ["Sheep"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getPosATL player, ["Sheep"],  3] select 0);[player, "sheep", _no] call INV_AddInventoryItem;player groupchat format["you got %1 sheep meat", _no];',
1,true,true,"",
'_w = (nearestobjects [getPosATL player, ["Sheep"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getPosATL player, ["Sheep"],  3] select 0) < 5 and !alive (nearestobjects [getPosATL player, ["Sheep"],  3] select 0) and isciv'];

action_h7 =	_role addaction ["Take Goat meat","noscript.sqf",
'_no = ceil(random 2);if (((call INV_GetOwnWeight) + ("goat" call INV_GetItemTypeKg)*_no) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};(nearestobjects [getPosATL player, ["Goat"],  3] select 0) setvariable ["inuse", 1, true]; player playmove "AinvPknlMstpSlayWrflDnon_medic";sleep 4;waituntil {animationstate player != "AinvPknlMstpSlayWrflDnon_medic"};deletevehicle (nearestobjects [getPosATL player, ["Goat"],  3] select 0);[player, "goat", _no] call INV_AddInventoryItem;player groupchat format["you got %1 goat meat", _no];',
1,true,true,"",
'_w = (nearestobjects [getPosATL player, ["Goat"],  3] select 0) getvariable "inuse"; isnil "_w" and player distance (nearestobjects [getPosATL player, ["Goat"],  3] select 0) < 5 and !alive (nearestobjects [getPosATL player, ["Goat"],  3] select 0) and isciv'];
...
//================================== COP DELETE EVIDENCE ================================================
//action23 = _role addaction ["Take evidence","noscript.sqf",'player groupchat "evidence removed."; {deletevehicle _x} foreach (nearestobjects [getPosATL player, ["weaponholder"], 3])',1,true,true,"",'_weps = (nearestobjects [getPosATL player, ["weaponholder"], 3] select 0); player distance _weps < 5 and iscop'];
//================================== COP SLAVE ACTIONS ================================================
action24 = _role addaction ["Who do you work for?","noscript.sqf",'player groupchat format["this slave works for %1.", leader (nearestobjects [getPosATL player, civslavearray,  3] select 0)]',1,true,true,"",'_slave = (nearestobjects [getPosATL player, civslavearray, 3] select 0); not([_slave] call player_human) and ((player distance _slave) < 5) and ([(leader _slave)] call player_human) and iscop'];
action25 = _role addaction ["Set slave free","noscript.sqf",'_slave = (nearestobjects [getPosATL player, civslavearray,  3] select 0); _civ = leader _slave; deletevehicle _slave; [player, "(human-exploitation)", 20000, 50, false] call player_update_warrants; player groupchat "the slave has been freed!";',1,true,true,"",'_slave = (nearestobjects [getPosATL player, civslavearray, 3] select 0); not([_slave] call player_human) and ((player distance _slave) < 5) and ([(leader _slave)] call player_human) and iscop'];
//==================================== OBJECT ACTIONS =================================================
//action89 = _role addaction ["Remove Searchlight","noscript.sqf",'if (((call INV_GetOwnWeight) + ("SearchLight_US_EP1" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["SearchLight_US_EP1"], 3] select 0);[player, "SearchLight_US_EP1", 1] call INV_AddInventoryItem;player groupchat "you picked up a searchlight";',1,true,true,"",'_light = (nearestobjects [getPosATL player, ["SearchLight_US_EP1"],  3] select 0); !(_light in speedcamarray) and player distance _light < 5 and iscop'];
//action26 = _role addaction ["Remove Roadblock","noscript.sqf",'if (((call INV_GetOwnWeight) + ("roadblock" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_CncBlock_Stripes"],  3] select 0);[player, "roadblock", 1] call INV_AddInventoryItem;player groupchat "you picked up a roadblock";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_CncBlock_Stripes"],  3] select 0) < 5 and iscop'];
//action27 = _role addaction ["Remove Bargate","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Bargate" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["ZavoraAnim"],  10] select 0);[player, "Bargate", 1] call INV_AddInventoryItem;player groupchat "you picked up a bargate";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["ZavoraAnim"],  10] select 0) < 7 and iscop'];
//action28 = _role addaction ["Remove Road Cone","noscript.sqf",'if (((call INV_GetOwnWeight) + ("roadcone" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_coneLight"],  3] select 0);[player, "roadcone", 1] call INV_AddInventoryItem;player groupchat "you picked up a road cone";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_coneLight"],  3] select 0) < 5 and iscop'];
//action91 = _role addaction ["Remove M2 Static","noscript.sqf",'if (((call INV_GetOwnWeight) + ("M2StaticMG_US_EP1" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["M2StaticMG_US_EP1"],  3] select 0);[player, "M2StaticMG_US_EP1", 1] call INV_AddInventoryItem;player groupchat "you picked up a M2 Static";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["M2StaticMG_US_EP1"],  3] select 0) < 5 and iscop'];
//action29 = _role addaction ["Open/close gate","noscript.sqf",'_gate = (nearestobjects [getPosATL player, ["ZavoraAnim"],  10] select 0); if(_gate animationPhase "bargate" == 1)then{_gate animate ["bargate", 0]}else{_gate animate ["bargate", 1]};',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["ZavoraAnim"],  10] select 0) < 7 and iscop'];
//action30 = _role addaction ["Open/close gate","noscript.sqf",'_gate = (nearestobjects [getPosATL player, ["ZavoraAnim"],  10] select 0); if(_gate animationPhase "bargate" == 1)then{_gate animate ["bargate", 0]}else{_gate animate ["bargate", 1]};',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["ZavoraAnim"],  10] select 0) < 7 and isciv'];
//action31 = _role addaction ["Remove Big bag fence (corner)","noscript.sqf",'if (((call INV_GetOwnWeight) + ("BigbagfenceCorner" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_fort_bagfence_corner"],  3] select 0);[player, "BigbagfenceCorner", 1] call INV_AddInventoryItem;player groupchat "you picked up a sandbag wall (corner)";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_fort_bagfence_corner"],  3] select 0) < 5'];
//action32 = _role addaction ["Remove Big bag fence","noscript.sqf",'if (((call INV_GetOwnWeight) + ("bigbagfence" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_fort_bagfence_long"],  3] select 0);[player, "bigbagfence", 1] call INV_AddInventoryItem;player groupchat "you picked up a sandbag wall";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_fort_bagfence_long"],  3] select 0) < 5'];
//action33 = _role addaction ["Remove Big bag fence (round)","noscript.sqf",'if (((call INV_GetOwnWeight) + ("bigbagfenceRound" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_fort_bagfence_round"],  3] select 0);[player, "bigbagfenceRound", 1] call INV_AddInventoryItem;player groupchat "you picked up a sandbag wall (round)";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_fort_bagfence_round"],  3] select 0) < 5'];
//action34 = _role addaction ["Remove Bunker (small)","noscript.sqf",'if (((call INV_GetOwnWeight) + ("bunkersmall" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_fortified_nest_small"],  3] select 0);[player, "bunkersmall", 1] call INV_AddInventoryItem;player groupchat "you picked up a bunker (small)";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_fortified_nest_small"],  3] select 0) < 5'];
//action35 = _role addaction ["Remove Danger Sign","noscript.sqf",'if (((call INV_GetOwnWeight) + ("danger" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Sign_Danger"],  3] select 0);[player, "danger", 1] call INV_AddInventoryItem;player groupchat "you picked up a danger sign";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Sign_danger"],  3] select 0) < 5'];
//action36 = _role addaction ["Remove Factory","noscript.sqf",'if (((call INV_GetOwnWeight) + ("factory" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_A_GeneralStore_01a"],  3] select 0);[player, "factory", 1] call INV_AddInventoryItem;player groupchat "you picked up a factory";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_A_GeneralStore_01a"],  3] select 0) < 5 and isciv'];
//action37 = _role addaction ["Remove Office Building","noscript.sqf",'if (((call INV_GetOwnWeight) + ("officebuilding" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["land_A_Office01"],  3] select 0);[player, "officebuilding", 1] call INV_AddInventoryItem;player groupchat "you picked up a officebuilding";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_A_office01"],  3] select 0) < 5 and isciv'];
//action38 = _role addaction ["Remove Barrack","noscript.sqf",'if (((call INV_GetOwnWeight) + ("barrack" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["land_Barrack2"],  3] select 0);[player, "barrack", 1] call INV_AddInventoryItem;player groupchat "you picked up a barrack";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_Barrack2"],  3] select 0) < 5 and isciv'];
//action39 = _role addaction ["Remove Hedgehog","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Hedgehog_EP1" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Hedgehog_EP1"],  3] select 0);[player, "Hedgehog_EP1", 1] call INV_AddInventoryItem;player groupchat "you picked up a Hedgehog";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Hedgehog_EP1"],  3] select 0) < 5 and iscop'];
//action40 = _role addaction ["Remove Checkpoint sign","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Sign_Checkpoint_US_EP1" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Sign_Checkpoint_US_EP1"],  3] select 0);[player, "Sign_Checkpoint_US_EP1", 1] call INV_AddInventoryItem;player groupchat "you picked up a Checkpoint sign";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Sign_Checkpoint_US_EP1"],  3] select 0) < 5 and iscop'];
//action410 = _role addaction ["Remove Camo net","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Land_CamoNetVar_NATO_EP1" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_CamoNetVar_NATO_EP1"],  3] select 0);[player, "Land_CamoNetVar_NATO_EP1", 1] call INV_AddInventoryItem;player groupchat "you picked up a Camo net";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_CamoNetVar_NATO_EP1"],  3] select 0) < 5'];
//action420 = _role addaction ["Remove Breaching ladder","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Land_ladderEP1" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_ladderEP1"],  5] select 0);[player, "Land_ladderEP1", 1] call INV_AddInventoryItem;player groupchat "you picked up a Breaching Ladder";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_ladderEP1"],  5] select 0) < 5'];
//action420 = _role addaction ["Remove Campfire","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Land_Campfire_burning" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Land_Campfire_burning"],  5] select 0);[player, "Land_Campfire_burning", 1] call INV_AddInventoryItem;player groupchat "you picked up a Campfire";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Land_Campfire_burning"],  5] select 0) < 5'];
//action430 = _role addaction ["Remove Road Barricade","noscript.sqf",'if (((call INV_GetOwnWeight) + ("Fort_Barricade_EP1" call INV_GetItemTypeKg)) > INV_CarryingCapacity)exitwith{player groupChat localize "STRS_inv_buyitems_maxgewicht"};deletevehicle (nearestobjects [getPosATL player, ["Fort_Barricade_EP1"],  5] select 0);[player, "Fort_Barricade_EP1", 1] call INV_AddInventoryItem;player groupchat "you picked up a Road Barricade";',1,true,true,"",'player distance (nearestobjects [getPosATL player, ["Fort_Barricade_EP1"],  5] select 0) < 5'];
//==================================== REPAIR POWER ===================================================
//action41 = _role addaction [format["Restore Power 1 ($%1)", powerrestorecost],"noscript.sqf",'_moneh = [player, "money"] call INV_GetItemAmount; if(_moneh < powerrestorecost)exitwith{player groupchat "you do not have enough money"};[player, "money", -(powerrestorecost)] call INV_AddInventoryItem; "power1 setdamage 0;" call broadcast',1,false,true,"","player distance power1 <= 7 and !alive power1 and iscop"];
//action42 = _role addaction [format["Restore Power 2 ($%1)", powerrestorecost],"noscript.sqf",'_moneh = [player, "money"] call INV_GetItemAmount; if(_moneh < powerrestorecost)exitwith{player groupchat "you do not have enough money"};[player, "money", -(powerrestorecost)] call INV_AddInventoryItem; "power2 setdamage 0;" call broadcast',1,false,true,"","player distance power2 <= 7 and !alive power2 and iscop"];
//================================== COP CHIEF ELECTION ===============================================
...
//====================================== VEHICLE ACTIONS ================================================
action68 = _role addaction [localize "STRS_addaction_trunk_see","noscript.sqf",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);_str = ([_vcl] call vehicle_storage_name);[_str] call A_SCRIPT_VEHICLECHECK;',1,true,true,"",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);player distance _vcl < 10 and not([player, _vcl] call vehicle_owner) and ([_vcl] call INV_IsPlayerVehicle) and iscop'];
action69 = _role addaction [localize "STRS_addaction_trunk_check","noscript.sqf",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);_str = ([_vcl] call vehicle_storage_name);if([_vcl,_str] call INV_RemoveIllegalStorage)then{call compile format["publicvariable ""%1"";", _str]};',1,true,true,"",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);player distance _vcl < 10 and not([player, _vcl] call vehicle_owner) and ([_vcl] call INV_IsPlayerVehicle) and iscop'];
action70 = _role addaction ["Impound vehicle","noscript.sqf",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);[_vcl] call A_impound_action;',1,true,true,"",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);player distance _vcl < 10 and ([_vcl] call INV_IsPlayerVehicle) and iscop'];
action71 = _role addaction ["Pull out","noscript.sqf",'(nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0) execVM "pullout.sqf";',1,true,true,"",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0); (player distance _vcl < 10) and ((count (crew _vcl) > 0) || ((count ([_vcl] call mounted_get_occupants)) > 0)) and ([_vcl] call INV_IsPlayerVehicle) and (call INV_IsArmed)'];
action72 = _role addaction [localize "STRS_addAction_vehicleinfo","noscript.sqf",'(nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0) call A_SCRIPT_VEHINFO;',1,true,true,"",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);player distance _vcl < 10 and ([_vcl] call INV_IsPlayerVehicle)'];
//action73 = nil;
//action74 = nil;
//action75 = nil;
//action76 = nil;
...
//========================   unflip vehicle     ================================
action86 = _role addaction ["Unflip vehicle","noscript.sqf","_this call vehicle_unflip;",1,false,true,"",'_vcl = (nearestobjects [getPosATL player, ["Air", "Ship", "LandVehicle"], 3] select 0);player distance _vcl < 5 and ([player, _vcl] call vehicle_owner)'];
//=========================    Cop Patrol actions   ==============================
...
//======================= Misc ==============================================
action109 = _role addaction [format["Doctor Operation ($%1)", A_DK_Price], "noscript.sqf", '[player] call A_DK_operation', 1 , false,true,"","([player] call A_DK_NearDoctor)"];
